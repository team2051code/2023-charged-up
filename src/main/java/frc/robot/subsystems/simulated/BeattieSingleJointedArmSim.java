...
/**
 * This is a copy of the WPILib SingleJointedArmSim with one tweak: arm length can be modified
 * after the arm is created. This is not a perfect simulation (the moment of inertia in the
 * linear system is not updated), but it is closer to real.
 */
public class BeattieSingleJointedArmSim extends LinearSystemSim<N2, N1, N1> {
   ...
   */
  public BeattieSingleJointedArmSim(
  ...
  /**
   * Sets a new arm length, in meters
   * @param armLength The new arm length, in meters
   */
  public void setArmLengthMeters(double armLength) {
    m_armLenMeters = armLength;
  }
